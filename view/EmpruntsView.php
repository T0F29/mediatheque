<h1>Emprunts en cours des membres</h1>
<h2>Bds</h2>
<div class="diaporama">
<?php
...
?>
        <div class="vignette">
            ...
            <div class="legende">
              ...
              <p>Article emprunté depuis le <?php echo $empruntBd->getDate_emprunt()->format('d/m/Y'); ?> par le membre numéro
            <?php
            $utilisateur = \Mediatheque\Model\Dao\ManagerUtilisateurs::recupererUtilisateurDUnEmprunt($empruntBd->getId());
...
?>
        <div class="vignette">
            ...
            <div class="legende">
              ...
              <p>Article emprunté depuis le <?php echo $empruntCd->getDate_emprunt()->format('d/m/Y'); ?>par le membre numéro
            <?php
            $utilisateur = \Mediatheque\Model\Dao\ManagerUtilisateurs::recupererUtilisateurDUnEmprunt($empruntCd->getId());
            echo $utilisateur[0]->getId().' ('.$utilisateur[0]->getPrenom().' '.$utilisateur[0]->getNom().')'
            ?>              
              </p>
            </div>
...
?>
        <div class="vignette">
            ...
            <div class="legende">
              ...
              <p>Article emprunté depuis le <?php echo $empruntLivre->getDate_emprunt()->format('d/m/Y'); ?>par le membre numéro
            <?php
            $utilisateur = \Mediatheque\Model\Dao\ManagerUtilisateurs::recupererUtilisateurDUnEmprunt($empruntLivre->getId());
            echo $utilisateur[0]->getId().' ('.$utilisateur[0]->getPrenom().' '.$utilisateur[0]->getNom().')'
            ?>
              </p>
            </div>
